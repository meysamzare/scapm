...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190402204253_initUpdate13_1")]
    partial class initUpdate13_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 4, 3, 1, 12, 53, 156, DateTimeKind.Local).AddTicks(6017),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("dedd0c20-1cfc-4a13-9601-10c20cd4c071"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
