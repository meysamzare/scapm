...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190720063341_initUpdate26")]
    partial class initUpdate26
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 20, 11, 3, 40, 407, DateTimeKind.Local).AddTicks(7907),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("b604c953-8312-4da7-adb7-c4837e98ffe6"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
