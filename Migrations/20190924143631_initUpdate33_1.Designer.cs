...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190924143631_initUpdate33_1")]
    partial class initUpdate33_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 9, 24, 18, 6, 30, 129, DateTimeKind.Local).AddTicks(2866),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("262a9d7e-5ed6-4cb5-be48-88fdad13e336"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
