...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190707061144_initUpdate23")]
    partial class initUpdate23
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 7, 10, 41, 43, 392, DateTimeKind.Local).AddTicks(6752),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("52bd7436-7f7f-446a-a9d9-63217c66720e"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
