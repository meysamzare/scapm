...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191107073138_initUpdate37_1")]
    partial class initUpdate37_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 11, 7, 11, 1, 37, 444, DateTimeKind.Local).AddTicks(1887),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("4e7f5276-3e10-4791-8bb1-7db9cbc6985c"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
