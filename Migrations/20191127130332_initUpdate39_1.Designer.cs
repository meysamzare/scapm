...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191127130332_initUpdate39_1")]
    partial class initUpdate39_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 11, 27, 16, 33, 31, 5, DateTimeKind.Local).AddTicks(8594),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("63677421-0e35-4caa-906c-ab5e7b3a1c04"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
