...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20200226112916_initUpdate40_3")]
    partial class initUpdate40_3
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2020, 2, 26, 14, 59, 14, 866, DateTimeKind.Local).AddTicks(5815),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("b0685dfb-088a-49ea-b4cc-c64ae9d06ae6"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
