...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190711051015_initUpdate25_1")]
    partial class initUpdate25_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 11, 9, 40, 13, 904, DateTimeKind.Local).AddTicks(4624),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("1b8a7fd2-889d-4b83-bc18-d083d9f64012"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
