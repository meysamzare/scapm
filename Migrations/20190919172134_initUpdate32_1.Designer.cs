...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190919172134_initUpdate32_1")]
    partial class initUpdate32_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 9, 19, 21, 51, 33, 327, DateTimeKind.Local).AddTicks(218),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("687a5eb9-aae3-4125-8b65-00b052d3e864"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
