...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190912162733_initUpdate31")]
    partial class initUpdate31
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 9, 12, 20, 57, 32, 643, DateTimeKind.Local).AddTicks(2967),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("cb5ca89d-94f2-44be-a095-d113c486b899"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
