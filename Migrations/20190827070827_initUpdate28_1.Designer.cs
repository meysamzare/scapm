...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190827070827_initUpdate28_1")]
    partial class initUpdate28_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 8, 27, 11, 38, 26, 307, DateTimeKind.Local).AddTicks(6718),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("e0e60b55-e0ef-426b-bd65-2903f7443b09"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
