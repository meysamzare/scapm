...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190331173030_initUpdate12")]
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 3, 31, 22, 0, 29, 374, DateTimeKind.Local).AddTicks(6324),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("8edd5c93-9f1c-4116-9112-1e1e806f611c"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
