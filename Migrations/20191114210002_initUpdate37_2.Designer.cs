...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191114210002_initUpdate37_2")]
    partial class initUpdate37_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 11, 15, 0, 29, 59, 279, DateTimeKind.Local).AddTicks(1623),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("59a19592-7d5c-47f7-b7c4-abfcfed18c45"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
