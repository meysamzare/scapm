...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190402091154_initUpdate13")]
    partial class initUpdate13
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 4, 2, 13, 41, 54, 200, DateTimeKind.Local).AddTicks(1480),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("f5fabf16-89fa-44af-99a2-ef5b0486abc6"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
