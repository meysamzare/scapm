...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190427164924_initUpdate14_1")]
    partial class initUpdate14_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 4, 27, 21, 19, 23, 597, DateTimeKind.Local).AddTicks(8176),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("f7d07a9c-d82f-4321-bba3-04358677f7a0"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
