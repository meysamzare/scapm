...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190925192121_initUpdate33_3")]
    partial class initUpdate33_3
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 9, 25, 22, 51, 19, 724, DateTimeKind.Local).AddTicks(7842),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("0b7d36d6-892c-4ff8-8a78-f1a923777501"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
