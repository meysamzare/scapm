...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191002080120_initUpdate34_1")]
    partial class initUpdate34_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 10, 2, 11, 31, 19, 54, DateTimeKind.Local).AddTicks(110),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("dafe2757-8729-4d09-b1f2-a770c241d20c"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
