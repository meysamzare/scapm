...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20200215052209_initUpdate40_1")]
    partial class initUpdate40_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2020, 2, 15, 8, 52, 8, 248, DateTimeKind.Local).AddTicks(6073),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("65ee146c-04cc-4f67-aedf-1f11c836c1db"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
