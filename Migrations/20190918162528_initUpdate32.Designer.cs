...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190918162528_initUpdate32")]
    partial class initUpdate32
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 9, 18, 20, 55, 27, 145, DateTimeKind.Local).AddTicks(560),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("210c99ee-2dbd-46ca-806b-279b933e48d9"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
