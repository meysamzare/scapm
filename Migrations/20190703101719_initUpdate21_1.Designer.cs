...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190703101719_initUpdate21_1")]
    partial class initUpdate21_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 3, 14, 47, 18, 929, DateTimeKind.Local).AddTicks(4751),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("6d5d4ce3-1ea7-43d2-abdf-dfadcf433588"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
