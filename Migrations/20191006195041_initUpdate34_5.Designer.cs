...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191006195041_initUpdate34_5")]
    partial class initUpdate34_5
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 10, 6, 23, 20, 40, 353, DateTimeKind.Local).AddTicks(7673),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("e8bba7e7-6e42-4d47-a1dc-d1cfc132a02d"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
