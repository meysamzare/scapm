...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191228181205_initUpdate40")]
    partial class initUpdate40
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 12, 28, 21, 42, 4, 322, DateTimeKind.Local).AddTicks(1266),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("772f5575-11c7-414f-90a6-a65c77f576d6"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
