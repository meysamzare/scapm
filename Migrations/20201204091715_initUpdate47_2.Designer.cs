...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20201204091715_initUpdate47_2")]
    partial class initUpdate47_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2020, 12, 4, 12, 47, 13, 641, DateTimeKind.Local).AddTicks(8991),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("2bcf7b92-cdc8-44fa-b039-e3f514e907c1"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
