...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191219183708_initUpdate39_5")]
    partial class initUpdate39_5
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 12, 19, 22, 7, 7, 304, DateTimeKind.Local).AddTicks(9228),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("b50b6cb9-239e-41ea-a473-a0b4a104fd20"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
