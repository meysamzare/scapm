...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190805134226_initUpdate27_2")]
    partial class initUpdate27_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 8, 5, 18, 12, 25, 223, DateTimeKind.Local).AddTicks(8025),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("0ef6a271-b9af-46c1-9d7d-d5e796671f4f"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
