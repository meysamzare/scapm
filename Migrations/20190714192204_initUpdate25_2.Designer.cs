...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190714192204_initUpdate25_2")]
    partial class initUpdate25_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 14, 23, 52, 3, 101, DateTimeKind.Local).AddTicks(2164),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("a6ab64b6-5946-426d-a224-848130ce3291"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
