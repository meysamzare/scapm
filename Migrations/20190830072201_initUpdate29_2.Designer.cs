...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190830072201_initUpdate29_2")]
    partial class initUpdate29_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 8, 30, 11, 52, 0, 631, DateTimeKind.Local).AddTicks(1572),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("bbd25597-4830-430a-94e5-f05fec03d566"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
