...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190630194458_initUpdate20_1")]
    partial class initUpdate20_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 1, 0, 14, 57, 823, DateTimeKind.Local).AddTicks(4618),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("723a1fe3-d2f2-4a7e-b644-0ea9fdf70771"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
