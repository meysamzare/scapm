...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190520201849_initUpdate15")]
    partial class initUpdate15
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 5, 21, 0, 48, 48, 531, DateTimeKind.Local).AddTicks(4554),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("3a4fc34f-6ffa-4536-8ef0-94a9022aca17"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
