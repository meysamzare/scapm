...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190629152341_initUpdate19")]
    partial class initUpdate19
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 6, 29, 19, 53, 41, 22, DateTimeKind.Local).AddTicks(6175),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("1d9bafde-4a53-4155-b8bc-5a8e4a7db393"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
            ...
            modelBuilder.Entity("SCMR_Api.Model.Student", b =>
                {
                    b.HasOne("SCMR_Api.Model.WorkBookHeader", "WorkBookHeader")
                        .WithOne()
                        .HasForeignKey("SCMR_Api.Model.Student", "Code")
                        .OnDelete(DeleteBehavior.Cascade);
                });
