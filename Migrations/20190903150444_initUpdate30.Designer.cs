...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190903150444_initUpdate30")]
    partial class initUpdate30
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 9, 3, 19, 34, 43, 127, DateTimeKind.Local).AddTicks(9546),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("549609d3-cdba-4430-a29a-22765aadcaac"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
