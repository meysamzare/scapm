...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190329171439_initUpdate11")]
    partial class initUpdate11
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 3, 29, 21, 44, 39, 231, DateTimeKind.Local).AddTicks(3685),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("6606ea60-b13e-481f-8841-7e174f1db8f0"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
