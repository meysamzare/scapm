...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190703195310_initUpdate21_2")]
    partial class initUpdate21_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 4, 0, 23, 9, 182, DateTimeKind.Local).AddTicks(8162),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("dd02f365-4ff6-415d-83d6-7b6ed55fbd4c"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
