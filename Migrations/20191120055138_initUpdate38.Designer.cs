...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191120055138_initUpdate38")]
    partial class initUpdate38
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 11, 20, 9, 21, 37, 399, DateTimeKind.Local).AddTicks(3877),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("85dbb9e2-1a14-4bbc-bf4b-5dffcb0e5784"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
