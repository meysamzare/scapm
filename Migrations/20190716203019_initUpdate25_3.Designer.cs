...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190716203019_initUpdate25_3")]
    partial class initUpdate25_3
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 17, 1, 0, 18, 262, DateTimeKind.Local).AddTicks(9025),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("5e744403-ec66-4fbe-81e4-256c17477c92"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
