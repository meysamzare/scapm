...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190704093208_initUpdate21_3")]
    partial class initUpdate21_3
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 4, 14, 2, 6, 833, DateTimeKind.Local).AddTicks(293),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("e907d88d-5f0f-4ad9-8ce6-fb8b5c11db9d"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
