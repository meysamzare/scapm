...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191006201454_initUpdate34_7")]
    partial class initUpdate34_7
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 10, 6, 23, 44, 52, 739, DateTimeKind.Local).AddTicks(2142),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("0885041e-0c9e-48b4-9ef3-790e37d25832"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
