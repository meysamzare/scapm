...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191107063139_initUpdate37")]
    partial class initUpdate37
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 11, 7, 10, 1, 38, 443, DateTimeKind.Local).AddTicks(9991),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("7aec0604-c70f-434b-823c-ffeac9401279"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
