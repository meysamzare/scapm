...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190816080229_initUpdate27_5")]
    partial class initUpdate27_5
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 8, 16, 12, 32, 28, 554, DateTimeKind.Local).AddTicks(2737),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("ee661ce7-3a53-4eec-b695-d620218cf758"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
