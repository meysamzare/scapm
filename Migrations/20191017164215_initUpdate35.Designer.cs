...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191017164215_initUpdate35")]
    partial class initUpdate35
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 10, 17, 20, 12, 14, 200, DateTimeKind.Local).AddTicks(1674),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("266ce3a3-7217-494b-a28f-e59249cc59f8"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
