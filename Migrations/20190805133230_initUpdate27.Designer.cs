...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190805133230_initUpdate27")]
    partial class initUpdate27
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 8, 5, 18, 2, 29, 474, DateTimeKind.Local).AddTicks(3796),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("1571669b-ad18-438c-9bfe-eb9a6fe863b7"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
