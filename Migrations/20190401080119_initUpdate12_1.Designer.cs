...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190401080119_initUpdate12_1")]
    partial class initUpdate12_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 4, 1, 12, 31, 19, 138, DateTimeKind.Local).AddTicks(5213),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("1ba1bbc1-ecb5-4832-ae9f-79e06f537931"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
