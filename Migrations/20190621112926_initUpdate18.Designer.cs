...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190621112926_initUpdate18")]
    partial class initUpdate18
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 6, 21, 15, 59, 25, 173, DateTimeKind.Local).AddTicks(911),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("c05de872-4dc5-4f93-ab15-56cdf0f690b0"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
