...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190413163640_initUpdate13_3")]
    partial class initUpdate13_3
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 4, 13, 21, 6, 38, 996, DateTimeKind.Local).AddTicks(3356),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("030e09bf-d55f-413e-bebf-382e0a8462bf"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
