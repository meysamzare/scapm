...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191121144730_initUpdate39")]
    partial class initUpdate39
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 11, 21, 18, 17, 29, 404, DateTimeKind.Local).AddTicks(1808),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("a60f0902-1f62-46e3-b706-01a8d2c1635a"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
