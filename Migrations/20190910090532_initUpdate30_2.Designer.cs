...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190910090532_initUpdate30_2")]
    partial class initUpdate30_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 9, 10, 13, 35, 31, 674, DateTimeKind.Local).AddTicks(725),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("5a74991d-5876-41ba-9bed-4655aaf06c45"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
