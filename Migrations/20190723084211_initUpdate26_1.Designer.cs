...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190723084211_initUpdate26_1")]
    partial class initUpdate26_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 23, 13, 12, 10, 697, DateTimeKind.Local).AddTicks(4970),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("d58a62f9-e085-4d5d-8256-7a3649f7faac"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
