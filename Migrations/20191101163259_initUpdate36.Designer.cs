...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191101163259_initUpdate36")]
    partial class initUpdate36
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 11, 1, 20, 2, 57, 969, DateTimeKind.Local).AddTicks(6177),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("8afc2cfd-1e37-4741-b49c-a662828cd472"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
