...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190521060554_initUpdate15_2")]
    partial class initUpdate15_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 5, 21, 10, 35, 53, 566, DateTimeKind.Local).AddTicks(5959),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("257d7c65-fab0-4b0a-b8af-4e504a8ab8f6"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
