...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190707061305_initUpdate23_1")]
    partial class initUpdate23_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 7, 10, 43, 4, 116, DateTimeKind.Local).AddTicks(1497),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("d7a08b9e-6b63-4a08-9b94-e4b4753df5f7"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
