...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190829154557_initUpdate29")]
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 8, 29, 20, 15, 56, 624, DateTimeKind.Local).AddTicks(9971),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("d461cd09-bdd2-4288-aecb-fa44706b8980"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
