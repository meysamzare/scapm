...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190730175726_initUpdate26_2")]
    partial class initUpdate26_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 30, 22, 27, 25, 463, DateTimeKind.Local).AddTicks(8456),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("938399a0-2046-40e7-90bf-342bf56fcd13"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
