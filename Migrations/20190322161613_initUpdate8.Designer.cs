...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190322161613_initUpdate8")]
    partial class initUpdate8
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 3, 22, 20, 46, 13, 9, DateTimeKind.Local).AddTicks(4729),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("a39296bb-4f8b-416a-bab7-c1fb7f52e013"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
