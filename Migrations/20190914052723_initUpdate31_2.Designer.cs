...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190914052723_initUpdate31_2")]
    partial class initUpdate31_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 9, 14, 9, 57, 22, 693, DateTimeKind.Local).AddTicks(880),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("498ef5ea-9419-491e-b6ec-8f3aa7935555"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
