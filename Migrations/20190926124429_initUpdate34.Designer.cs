...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190926124429_initUpdate34")]
    partial class initUpdate34
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 9, 26, 16, 14, 28, 431, DateTimeKind.Local).AddTicks(9230),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("06923c76-53fe-47f2-bc41-330db57ab5ed"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
