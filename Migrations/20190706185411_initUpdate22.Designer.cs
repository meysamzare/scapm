...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190706185411_initUpdate22")]
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 6, 23, 24, 9, 827, DateTimeKind.Local).AddTicks(4805),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("ad176413-d56d-4a73-94d7-ac706e3fc703"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
