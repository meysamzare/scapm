...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190710175828_initUpdate25")]
    partial class initUpdate25
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 10, 22, 28, 26, 671, DateTimeKind.Local).AddTicks(2054),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("255e2ab2-5945-4a8c-9bd2-5be0224056bc"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
