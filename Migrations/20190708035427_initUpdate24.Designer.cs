...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190708035427_initUpdate24")]
    partial class initUpdate24
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 8, 8, 24, 26, 660, DateTimeKind.Local).AddTicks(4428),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("7965bede-e2c7-4147-bcd9-1be61287b3ac"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
