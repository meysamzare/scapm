...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20200517065139_initUpdate42_1")]
    partial class initUpdate42_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2020, 5, 17, 11, 21, 38, 426, DateTimeKind.Local).AddTicks(8941),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("426afadc-085a-41b3-93d9-eb4f3806afb4"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
