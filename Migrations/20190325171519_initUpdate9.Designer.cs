...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190325171519_initUpdate9")]
    partial class initUpdate9
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 3, 25, 21, 45, 18, 761, DateTimeKind.Local).AddTicks(2629),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("c073f383-0c7b-47b5-8e37-0d9cac7dd826"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
