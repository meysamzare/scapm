...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190404165756_initUpdate13_2")]
    partial class initUpdate13_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 4, 4, 21, 27, 55, 696, DateTimeKind.Local).AddTicks(6423),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("166eb1ce-b3ac-453c-96f7-229a25e272a6"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
