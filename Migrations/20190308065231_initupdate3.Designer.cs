...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190308065231_initupdate3")]
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 3, 8, 10, 22, 30, 532, DateTimeKind.Local).AddTicks(5174),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("a8c76a0a-7907-461f-a532-1ed91c57a35f"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
