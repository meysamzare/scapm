...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191213200322_initUpdate39_4")]
    partial class initUpdate39_4
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 12, 13, 23, 33, 21, 607, DateTimeKind.Local).AddTicks(4396),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("2256e8b2-17fc-4783-8ec8-b92bd15509cf"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
