...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190826070505_initUpdate28")]
    partial class initUpdate28
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 8, 26, 11, 35, 4, 30, DateTimeKind.Local).AddTicks(5429),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("40566422-5366-4254-8e50-e75a04478b8b"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
