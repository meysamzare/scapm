...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190521060138_initUpdate15_1")]
    partial class initUpdate15_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 5, 21, 10, 31, 38, 74, DateTimeKind.Local).AddTicks(7453),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("4081f875-ad24-471c-aa1a-47b7a12e3108"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
