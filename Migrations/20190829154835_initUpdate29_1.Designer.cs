...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190829154835_initUpdate29_1")]
    partial class initUpdate29_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 8, 29, 20, 18, 34, 137, DateTimeKind.Local).AddTicks(359),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("93247a59-ab97-4123-9418-1bfbe3784de0"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
