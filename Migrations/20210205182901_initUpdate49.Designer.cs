...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20210205182901_initUpdate49")]
    partial class initUpdate49
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2021, 2, 5, 21, 59, 1, 410, DateTimeKind.Local).AddTicks(6401),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("e080c600-d9d0-419b-a786-0cd79cca86e0"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
