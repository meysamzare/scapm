...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190707062910_initUpdate23_2")]
    partial class initUpdate23_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 7, 10, 59, 9, 221, DateTimeKind.Local).AddTicks(4081),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("12bd480c-934a-4947-931d-caab763acc42"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
