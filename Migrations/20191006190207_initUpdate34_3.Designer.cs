...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191006190207_initUpdate34_3")]
    partial class initUpdate34_3
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 10, 6, 22, 32, 5, 283, DateTimeKind.Local).AddTicks(8868),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("ec8fea38-a84e-4062-8562-d2980e402a31"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
