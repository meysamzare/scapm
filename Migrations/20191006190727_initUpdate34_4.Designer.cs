...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20191006190727_initUpdate34_4")]
    partial class initUpdate34_4
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 10, 6, 22, 37, 26, 319, DateTimeKind.Local).AddTicks(8447),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("a4f7279e-9d5e-4ab7-838a-9327b11b3a4f"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
