...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190521064547_initUpdate15_3")]
    partial class initUpdate15_3
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 5, 21, 11, 15, 47, 232, DateTimeKind.Local).AddTicks(8208),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("e4712af0-3e29-4da5-94ed-856f13c532c7"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
