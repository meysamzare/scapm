...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190924200421_initUpdate33_2")]
    partial class initUpdate33_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 9, 24, 23, 34, 19, 608, DateTimeKind.Local).AddTicks(8648),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("55d46007-3464-4dcf-9c03-dc31a7ca60df"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
