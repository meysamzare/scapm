...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190601072328_initUpdate16")]
    partial class initUpdate16
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 6, 1, 11, 53, 27, 513, DateTimeKind.Local).AddTicks(3270),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("9133f577-386f-47c7-9fea-9fcca469f2d4"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
