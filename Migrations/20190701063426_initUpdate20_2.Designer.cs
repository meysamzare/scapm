...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190701063426_initUpdate20_2")]
    partial class initUpdate20_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 1, 11, 4, 25, 867, DateTimeKind.Local).AddTicks(5734),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("019081f9-d079-4b22-9caa-1e9a7711aafa"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
