...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190703075316_initUpdate21")]
    partial class initUpdate21
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 7, 3, 12, 23, 15, 128, DateTimeKind.Local).AddTicks(120),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("2daa4af2-64f2-4dbf-ab27-e463acff0ca7"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
