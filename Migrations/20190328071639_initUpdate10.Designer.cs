...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190328071639_initUpdate10")]
    partial class initUpdate10
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 3, 28, 11, 46, 39, 349, DateTimeKind.Local).AddTicks(6070),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("ebf29eda-fae2-49ab-bad9-8db905212214"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
