...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190630153658_initUpdate20")]
    partial class initUpdate20
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 6, 30, 20, 6, 57, 370, DateTimeKind.Local).AddTicks(2996),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("7d4fb1e3-a6ed-4c00-87a1-8e557a9e5c7c"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
