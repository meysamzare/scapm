...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20200216234119_initUpdate40_2")]
    partial class initUpdate40_2
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2020, 2, 17, 3, 11, 17, 658, DateTimeKind.Local).AddTicks(6679),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("2669cb0f-b1f3-422c-8740-e81a255bb209"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
