...
namespace SCMR_Api.Migrations
{
    ...
    [Migration("20190904111143_initUpdate30_1")]
    partial class initUpdate30_1
    {
            ...
            modelBuilder.Entity("SCMR_Api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateAdd = new DateTime(2019, 9, 4, 15, 41, 42, 451, DateTimeKind.Local).AddTicks(7411),
                            DateEdit = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Firstname = "میثم",
                            GId = new Guid("a67e519f-0ac6-4c8a-8332-c14b1360cb77"),
                            Lastname = "زارع",
                            MeliCode = "2282795547",
                            Password = "12345678",
                            RoleId = 1,
